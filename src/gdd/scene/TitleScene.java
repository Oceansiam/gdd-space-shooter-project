...
public class TitleScene extends JPanel {
    ...
    private void initAudio() {
        // Off-thread for the same reason as Scene1's initAudio: this is
        // blocking I/O that could otherwise freeze the whole window if it
        // stalls on real audio hardware.
        new Thread(() -> {
            try {
