...
/**
 * A projectile fired by an enemy (or the Stage 2 boss), traveling left
 * toward the player.
 *
...
public class EnemyShot extends Sprite {
    ...
    public static final int SPEED = 7; // default (Stage 1)
    ...
    /** Lets a faster stage (e.g. Stage 2) fire quicker shots than the default. */
